...
ifelse(`X'_ARG_,`X2',`You hold 3 six-sided dice in your hand. You toss them on a table where they come to rest squarely.')dnl
\begin{enumerate}[(a)]
    \item How many discrete states are there in this system?
    \item What is the base of this system?
